...
> «Standing» — кодовое имя движка (англ. *standing* = и «положение/статус в сообществе», и «турнирная
> таблица»). **UI-бренд — «Crown»** (ADR 0022): в интерфейсе донат — *Crown*, репутация — *Reign*,
> тиры — *ранги* (Squire…King), канал — *realm*. Это ярлыки поверх того же движка; механика и
> инварианты §4 не меняются.
